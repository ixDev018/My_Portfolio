...
<div x-data="{
    ...
    allProjects: {{ $projects->map(fn($p) => [
        ...
        'thumbnail_path' => $p->thumbnail_path ? Storage::url($p->thumbnail_path) : null,
        'thumbnail_video_path' => $p->thumbnail_video_path ? Storage::url($p->thumbnail_video_path) : ($p->main_media_type === 'video' && $p->main_video_path ? Storage::url($p->main_video_path) : ($p->main_media_type === 'video' ? $p->video_url : null)),
